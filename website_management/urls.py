...
urlpatterns = patterns('',
                       ...
                       url(r'^webpage_detail/(?P<web_id>\d+)/$',
                           views.webpage_detail,
                           name='webpage_detail'),
                       url(r'^homepage_detail/(?P<hp_id>\d+)/$',
                           views.homepage_detail,
                       ...
                       url(r'^view_all_webpages/$',
                           views.view_all_webpages,
                           name='view_all_webpages'),
                       url(r'^view_all_homepages/$',
                           views.view_all_homepages,
